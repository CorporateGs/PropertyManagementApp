        ...
        <CardContent>
          <div className="space-y-3">
            {filteredCommunications.map((communication) => {
              ...
              return (
                <div key={communication.id} className={`border rounded-lg p-4 hover:shadow-md transition-shadow ${
                  communication.isImportant ? 'border-red-200 bg-red-50' : ''
                } ${
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3 flex-1">
                      <div className={`p-2 rounded-lg ${
                        communication.direction === 'Inbound' ? 'bg-blue-100' : 'bg-green-100'
                      }`}>
                        <TypeIcon className={`h-5 w-5 ${
                          communication.direction === 'Inbound' ? 'text-blue-600' : 'text-green-600'
                        }`} />
                      </div>
